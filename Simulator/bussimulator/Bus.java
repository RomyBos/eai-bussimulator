...
//			System.out.println(bericht.lijnNaam + " naar halte" + eta.halteNaam + " t=" + tijdNaarHalte);
	...
	/*
		In de bussimulator in de klasse Bus moet de methode sendBericht  geïmplementeerd worden. Deze moet de Producer
		aanspreken om een XML bericht met het formaat zoals in het bijgevoegde XML voorbeeld bestand te versturen naar de Anypoint flow.
	 */

	public void sendBericht(Bericht bericht){
		//Done: gebruik XStream om het binnengekomen bericht om te zetten naar een XML bestand (String)
    	XStream xstream = new XStream();

    	//Done: zorg er voor dat de XML-tags niet het volledige pad van de omgezettte klassen bevat
    	xstream.alias("ETA", bussimulator.ETA.class);
    	xstream.alias("Bericht", bussimulator.Bericht.class);

    	//Done: maak de XML String aan en verstuur het bericht
